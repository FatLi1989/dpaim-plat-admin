package com.jtsec.dpaim.plat.admin.controller;
...
public class LoginController {
	...
	public HttpResponse Login (UserVo user) {
		...
		UsernamePasswordToken token = new UsernamePasswordToken (user.getLoginName (), user.getPassword (), user.getRememberMe ());
