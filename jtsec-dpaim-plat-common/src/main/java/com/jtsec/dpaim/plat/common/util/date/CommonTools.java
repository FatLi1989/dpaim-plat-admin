package com.jtsec.dpaim.plat.common.util.date;
...
public class CommonTools {
	...
	//一天内每小时0-23的参照数组
	public static List<String> hourList = new ArrayList<String> ();
	...
	public static String getTime (Date dt, String type, int offset) {
		...
		//时间类型为分钟
		if (Constants.WHOLE_MIN_TYPE.equals (type)) {
		...
		//时间类型为小时
		if (Constants.WHOLE_HOUR_TYPE.equals (type)) {
		...
		//时间类型为天
		if (Constants.WHOLE_DAY_TYPE.equals (type)) {
...
//		System.out.println(date);
		...
		String str = CommonTools.offsetSecond ("2015-10-15 15:27:03", -1);
		System.out.println (str);

	}

	//一小时内每分钟0-59的参照数组
	public static List<String> minList = new ArrayList<String> ();
